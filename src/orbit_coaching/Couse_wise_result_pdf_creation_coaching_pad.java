...
public class Couse_wise_result_pdf_creation_coaching_pad {



    Couse_wise_result_pdf_creation_coaching_pad(String cls,String exam_type,String date,String subject,String total,String highest,String lowest,
                                   String average) {
        try {
