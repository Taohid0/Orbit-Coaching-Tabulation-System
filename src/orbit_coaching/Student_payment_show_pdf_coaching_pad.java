...
public class Student_payment_show_pdf_coaching_pad {

    String name = "",address = "",contact_number = "";

    Student_payment_show_pdf_coaching_pad(String reg,String yr,String st_name,String fname,String mname,String school) {
        try {
