...
public class Show_expense_for_teacher_pdf {

    String name = "",address = "",contact_number = "";

    Show_expense_for_teacher_pdf(String yr) {
        try {
            try
            {
            ...
            String pdf_name ="PDF\\"+Calendar.getInstance().getTime().toString()+"Expense for Teacher "+yr+".pdf";
