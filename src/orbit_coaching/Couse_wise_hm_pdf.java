...
public class Couse_wise_hm_pdf {

    String name = "",address = "",contact_number = "";

    Couse_wise_hm_pdf(String cls,String exam_type,String date,String subject,String total,String highest,String lowest,
                                   String average) {
        try {
            try
            {
...
//                am_pc="PM";
            ...
            String pdf_name =Calendar.getInstance().getTime().toString()+" Course wise result name_wise "+exam_type+" "+subject+".pdf";
