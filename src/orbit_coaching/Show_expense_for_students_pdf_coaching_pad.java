...
public class Show_expense_for_students_pdf_coaching_pad {

    String name = "",address = "",contact_number = "";

    Show_expense_for_students_pdf_coaching_pad(String yr) {
        try {

            Document document = new Document(PageSize.A4, 50, 50, 50, 50);


            String pdf_name ="PDF\\"+Calendar.getInstance().getTime().toString()+"Expense for Student "+yr+"" +
                    "coaching pad.pdf";
