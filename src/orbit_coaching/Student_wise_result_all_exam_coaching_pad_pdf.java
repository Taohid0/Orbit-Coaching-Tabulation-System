...
public class Student_wise_result_all_exam_coaching_pad_pdf {
    boolean flag = false;
    ...
    Student_wise_result_all_exam_coaching_pad_pdf(String yr,String cls,String reg_number,String st_name) {
        try {
