...
public class Show_expense_for_teacher_pdf_coaching_pad {

    String name = "",address = "",contact_number = "";

    Show_expense_for_teacher_pdf_coaching_pad(String yr) {
        try {

            Document document = new Document(PageSize.A4, 50, 50, 50, 50);


            String pdf_name ="PDF\\"+Calendar.getInstance().getTime().toString()+"Expense for Teacher " +
                    "coaching pad"+yr+".pdf";
            ...
            p1 = new Paragraph(" Total Expense For Teachers ("+yr+")",
            ...
            int total=0;
            try {
                ResultSet resultSet = Database_query.get_expense_year_teacher(yr);
