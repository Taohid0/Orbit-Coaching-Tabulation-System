...
public class Other_income_pdf {

    String name = "",address = "",contact_number = "";

    Other_income_pdf(String yr) {
        try {
            try
            {
            ...
            String pdf_name ="PDF\\"+Calendar.getInstance().getTime().toString()+" Total Other Income "+yr+".pdf";
            ...
            p1 = new Paragraph("Total Other Income Of Year : "+yr,
