...
public class Total_expense_pdf_coaching_pdf {

    String name = "",address = "",contact_number = "";

    Total_expense_pdf_coaching_pdf(String yr) {
        try {
            Document document = new Document(PageSize.A4, 50, 50, 50, 50);


            String pdf_name ="PDF\\"+Calendar.getInstance().getTime().toString()+" Total Expense "+yr+"Coaching pad.pdf";
